...
try
	...
	Set_Secs(0)
	Assert_Equal(30, (4 * 1000), Get_Parts())

	Eval0(turn)
	Assert_Equal(31, 0, Get_Secs())
	Assert_Equal(32, (166667 + 4000), Get_Parts())
	Eval0(turn)
	Assert_Equal(33, 0, Get_Secs())
	Assert_Equal(34, (333334 + 4000), Get_Parts())
	Eval0(turn)
	Assert_Equal(35, 0, Get_Secs())
	Assert_Equal(36, (500001 + 4000), Get_Parts())
	Eval0(turn)
	Assert_Equal(37, 0, Get_Secs())
	Assert_Equal(38, (666668 + 4000), Get_Parts())
	Eval0(turn)
	Assert_Equal(39, 0, Get_Secs())
	Assert_Equal(40, (833335 + 4000), Get_Parts())
	Eval0(turn)
	Assert_Equal(41, 1, Get_Secs())		# (1004002 / 1000000)
	Assert_Equal(42, 4002, Get_Parts())	# (1004002 % 1000000)
