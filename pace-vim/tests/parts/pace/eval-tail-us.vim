...
Assert_Equal(501, [-1, 999999], Reltime([0, 0], [0, -1]))
...
try
	...
	Assert_Equal(97, (12 * 1000), pace.carry)
...
####	Set_Parts(pace.carry)
	...
	Assert_Equal(99, (166667 + 12000), Get_Parts())
	doautocmd pace CursorMovedI
	Assert_Equal(100, 0, Get_Secs())
	Assert_Equal(101, (333334 + 12000), Get_Parts())
	doautocmd pace CursorMovedI
	Assert_Equal(102, 0, Get_Secs())
	Assert_Equal(103, (500001 + 12000), Get_Parts())
	doautocmd pace CursorMovedI
	Assert_Equal(104, 0, Get_Secs())
	Assert_Equal(105, (666668 + 12000), Get_Parts())
	doautocmd pace CursorMovedI
	Assert_Equal(106, 0, Get_Secs())
	Assert_Equal(107, (833335 + 12000), Get_Parts())
	doautocmd pace CursorMovedI
	Assert_Equal(108, 1, Get_Secs())	# (1012002 / 1000000)
	Assert_Equal(109, 12002, Get_Parts())	# (1012002 % 1000000)
	...
	doautocmd pace InsertLeave
	Assert_Equal(123, (166667 + 12002), pace.carry)
	mockup.mode = 'n'
	...
	try
		...
		Assert_Equal(134, 166667, Get_Parts())
		doautocmd pace CursorMovedI
		Assert_Equal(135, 0, Get_Secs())
		Assert_Equal(136, 333334, Get_Parts())
		doautocmd pace CursorMovedI
		Assert_Equal(137, 0, Get_Secs())
		Assert_Equal(138, 500001, Get_Parts())
		doautocmd pace CursorMovedI
		Assert_Equal(139, 0, Get_Secs())
		Assert_Equal(140, 666668, Get_Parts())
		doautocmd pace CursorMovedI
		Assert_Equal(141, 0, Get_Secs())
		Assert_Equal(142, 833335, Get_Parts())
		doautocmd pace CursorMovedI
		...
		doautocmd pace InsertLeave
		Assert_Equal(162, (166667 + 2), pace.carry)
		mockup.mode = 'n'
