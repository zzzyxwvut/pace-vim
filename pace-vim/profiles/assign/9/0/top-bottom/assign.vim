...
# Description:	A _top-bottom_ runner for the "Eval*" functions (Vim 9.0)
...
def Eval1(go: dict<any>)
	...
	go.b = go.b + tick[0] + (tick[1] + go.c) / 1000000
	go.c = (tick[1] + go.c) % 1000000
	go.d = go.d + 1
...
def Eval1(go: dict<any>)
	const tick: list<number> = reltime(go.a)
	go.b = go.b + tick[0] + (tick[1] + go.c) / 1000000000
	go.c = (tick[1] + go.c) % 1000000000
	go.d = go.d + 1
	g:runner_info = printf('%-9s %2i, %7i, %5i',
...
def Eval1(go: dict<any>)
	...
	go.b = go.b + str2nr(unit) + micros / 1000000
	go.c = micros % 1000000
	go.d = go.d + 1
	g:runner_info = printf('%-9s %2i, %7i, %5i',
			trim(unit)[: -5] .. ',',
...
def g:Assign_Runner_TB_9_0(fname: string, lines: number,
