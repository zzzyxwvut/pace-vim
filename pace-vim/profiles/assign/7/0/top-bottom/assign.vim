" Description:	A _top-bottom_ runner for the "Eval*" functions (Vim 7.0)
...
function! s:Eval1(go) abort						" {{{1
	...
	let a:go.b = a:go.b + l:tick[0] + (l:tick[1] + a:go.c) / 1000000
	let a:go.c = (l:tick[1] + a:go.c) % 1000000
	let a:go.d = a:go.d + 1
...
function! s:Eval1(go) abort						" {{{1
	let l:tick = reltime(a:go.a)
	let a:go.b = a:go.b + l:tick[0] + (l:tick[1] + a:go.c) / 1000000000
	let a:go.c = (l:tick[1] + a:go.c) % 1000000000
	let a:go.d = a:go.d + 1
	let g:runner_info = printf('%-9s %2i, %7i, %5i',
...
function! s:Eval1(go) abort						" {{{1
	...
	let a:go.b = a:go.b + str2nr(l:unit) + l:micros / 1000000
	let a:go.c = l:micros % 1000000
	let a:go.d = a:go.d + 1
	let g:runner_info = printf('%-9s %2i, %7i, %5i',
...
function! Assign_Runner_TB_7_0(fname, lines, times, delay) abort	" {{{1
